def pbScriptedBattleAnimation(bgm=nil,battletype=0,foe=nil, player=nil)
  ...
  handled = pbScriptedBattleAnimationOverride(viewport,battletype,foe,player)
...
def pbScriptedBattleAnimationOverride(viewport,battletype=0,foe=nil, players=nil)
  ##### VS. animation, by Luka S.J. #####
  ##### Tweaked by Maruno           #####
  if (battletype==1 || battletype==3) && foe.length==1   # Against single trainer
    tr_type = (foe[0].trainer_type rescue -1)
    player_tr_type = (players[0].trainer_type rescue -1)
    if tr_type && player_tr_type
      ...
      pgraphic    = sprintf("vsTrainer_%s", tr_type.to_s) rescue nil

      resolvedBitmaps = 
      pbResolveBitmap("Graphics/Transitions/" + tbargraphic) && 
      pbResolveBitmap("Graphics/Transitions/" + tgraphic) && 
      pbResolveBitmap("Graphics/Transitions/" + pbargraphic) && 
      pbResolveBitmap("Graphics/Transitions/" + pgraphic)
