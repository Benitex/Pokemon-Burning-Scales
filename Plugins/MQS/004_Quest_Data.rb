module QuestModule
  ...
  Quest9 = {
    ...
    :Stage4 => "Investigue o Relic Castle.",
  ...
  Quest10 = {
    ...
    :Stage6 => "Converse com a mãe da Anna.",
    :Location1 => "Nimbasa",
  ...
  Quest16 = {
    ...
    :Location1 => "Rota 4",
	  :Location2 => "Rota 4",
    :QuestDescription => "Um ciêntista pervertido me pediu para entregar uma carta de amor para uma menina na praia da Rota 4.",
  }
  ...
  Quest17 = {
    ...
    :QuestDescription => "Motoqueiros estão causando confusão na Rota 4, o melhor a se fazer é acabar com essa bagunça. Devo decidir o que fazer com os guardas em Castelia e prosseguir com o ataque em defesa da Rota 4.",
  }
  ...
  Quest18 = {
    ...
    :QuestDescription => "Um senhor que me desafiou a mostrar 10 espécies diferentes na pokédex e em troca, me dará um pokemon que vem de fora do sul de Unova.",
  }
  ...
  Quest20 = {
    ...
    :QuestDescription => "Um policial na Delegacia de Castelia me pediu para fazer pesquisas de opinião sobre as eleições com pessoas pelas ruas de Castelia. Devo conversar com 3 pessoas e descobrir o que elas pensam dos Clubes.",
  }
  ...
  Quest21 = {
    ...
    :QuestDescription => "Vários treinadores de Castelia estão reportando que seus pokemon estão desaparecendo das boxes. Preciso resolver esse problema e trazer esses pokemon de volta.",
  }
  ...
  Quest26 = {
    ...
    :QuestDescription => "No Game Corner, descobri que existem dois jogadores profissionais de Triple Triad que desafiam outros jogadores em jogos com regras especiais. Enfrentar eles pode ser uma boa ideia.",
  }
  ...
  Quest33 = {
    :ID => "33",
    :Name => "Inspeção em A Taverna",
    :QuestGiver => "Delegacia de Castelia",
    :Stage1 => "Investigue A Taverna.",
    :Stage2 => "Relate as informações adquiridas.",
    :Location1 => "Gym Street",
    :Location2 => "Delegacia de Castelia",
